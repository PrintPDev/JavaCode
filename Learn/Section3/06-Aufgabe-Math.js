...
console.log("Rechnungsbetrag " + rechnung + "$" + " Der Gesamtbetrag beträgt " + Math.ceil((rechnung * 0.15) + rechnung))
console.log("Rechnungsbetrag " + rechnung2 + "$" + " Der Gesamtbetrag beträgt " + Math.ceil((rechnung2 * 0.15) + rechnung2))
console.log("Rechnungsbetrag " + rechnung3 + "$" + " Der Gesamtbetrag beträgt " + Math.ceil((rechnung3 * 0.15) + rechnung3)) 